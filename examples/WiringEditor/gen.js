...
modules: [
    ...
    },
    {
	    ...
	    {"collapsible": "true", "inputParams": {"label": "all", "name": "all", "value": "false" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "fail-if-not-equal", "name": "fail-if-not-equal", "value": "false" } }
        ]
                }
    },
    {
	    ...
	    {"inputParams": {"label": "limit", "name": "limit", "value": "" } }
        ]
                }
    },
    {
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "path", "name": "path", "required": "true" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "doctype-system", "name": "doctype-system" } },
	    {"inputParams": {"label": "escape-uri-attributes", "name": "escape-uri-attributes", "value": "false" } },
	    {"inputParams": {"label": "include-content-type", "name": "include-content-type", "value": "true" } },
	    {"inputParams": {"label": "indent", "name": "indent", "value": "false" } },
	    {"inputParams": {"label": "media-type", "name": "media-type" } },
	    {"inputParams": {"label": "method", "name": "method", "value": "xml" } },
	    {"inputParams": {"label": "omit-xml-declaration", "name": "omit-xml-declaration", "value": "true" } },
	    {"inputParams": {"label": "standalone", "name": "standalone", "value": "omit" } },
	    {"inputParams": {"label": "undeclare-prefixes", "name": "undeclare-prefixes" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "byte-order-mark", "name": "byte-order-mark" } },
	    {"inputParams": {"label": "cdata-section-elements", "name": "cdata-section-elements", "value": "" } },
	    {"inputParams": {"label": "doctype-public", "name": "doctype-public" } },
	    {"inputParams": {"label": "doctype-system", "name": "doctype-system" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "position", "name": "position", "required": "true" } }
        ]
                }
    },
    {
	    ...
	    {"inputParams": {"label": "match", "name": "match", "value": "*" } },
	    {"inputParams": {"label": "replace", "name": "replace", "value": "true" } }
        ]
                }
    },
    {
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "match", "name": "match", "required": "true" } },
	    {"inputParams": {"label": "base-uri", "name": "base-uri" } }
        ]
                }
    },
    {
	    ...
	    {"inputParams": {"label": "from", "name": "from" } },
	    {"inputParams": {"label": "to", "name": "to" } },
	    {"inputParams": {"label": "apply-to", "name": "apply-to", "value": "all" } }
        ]
                }
    },
    {
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "initial-only", "name": "initial-only", "value": "false" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "namespace", "name": "namespace" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "fixup-xml-base", "name": "fixup-xml-base", "value": "false" } },
	    {"inputParams": {"label": "fixup-xml-lang", "name": "fixup-xml-lang", "value": "false" } }
        ]
                }
    },
    {
	    ...
	    {"inputParams": {"label": "output-base-uri", "name": "output-base-uri" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "source-is-xml", "name": "source-is-xml", "value": "true" } },
	    {"inputParams": {"label": "result-is-xml", "name": "result-is-xml", "value": "true" } },
	    {"inputParams": {"label": "wrap-result-lines", "name": "wrap-result-lines", "value": "false" } },
	    {"inputParams": {"label": "errors-is-xml", "name": "errors-is-xml", "value": "false" } },
	    {"inputParams": {"label": "wrap-error-lines", "name": "wrap-error-lines", "value": "false" } },
	    {"inputParams": {"label": "fix-slashes", "name": "fix-slashes", "value": "false" } },
	    {"inputParams": {"label": "byte-order-mark", "name": "byte-order-mark" } },
	    {"inputParams": {"label": "cdata-section-elements", "name": "cdata-section-elements", "value": "" } },
	    {"inputParams": {"label": "doctype-public", "name": "doctype-public" } },
	    {"inputParams": {"label": "doctype-system", "name": "doctype-system" } },
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "dtd-attribute-values", "name": "dtd-attribute-values", "value": "false" } },
	    {"inputParams": {"label": "dtd-id-idref-warnings", "name": "dtd-id-idref-warnings", "value": "false" } },
	    {"inputParams": {"label": "assert-valid", "name": "assert-valid", "value": "true" } }
        ]
                }
    },
    {
    ...
    },
    {
	    ...
	    {"inputParams": {"label": "use-location-hints", "name": "use-location-hints", "value": "false" } },
	    {"inputParams": {"label": "try-namespaces", "name": "try-namespaces", "value": "false" } },
	    {"inputParams": {"label": "assert-valid", "name": "assert-valid", "value": "true" } },
	    {"inputParams": {"label": "mode", "name": "mode", "value": "strict" } }
        ]
                }
    },
    {
